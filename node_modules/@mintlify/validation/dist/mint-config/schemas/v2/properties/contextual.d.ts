import { z } from 'zod';
export declare const contextualOptions: readonly ["copy", "assistant", "view", "download-spec", "chatgpt", "claude", "perplexity", "grok", "aistudio", "devin", "windsurf", "mcp", "add-mcp", "cursor", "vscode", "devin-mcp"];
...
export declare const contextualSchema: z.ZodObject<{
    options: z.ZodEffects<z.ZodArray<z.ZodUnion<[z.ZodEnum<["copy", "assistant", "view", "download-spec", "chatgpt", "claude", "perplexity", "grok", "aistudio", "devin", "windsurf", "mcp", "add-mcp", "cursor", "vscode", "devin-mcp"]>, z.ZodObject<{
        title: z.ZodString;
        description: z.ZodString;
        icon: z.ZodOptional<z.ZodUnion<[z.ZodEffects<z.ZodString, string, string>, z.ZodObject<{
            style: z.ZodOptional<z.ZodEnum<["brands", "duotone", "light", "regular", "sharp-duotone-solid", "sharp-light", "sharp-regular", "sharp-solid", "sharp-thin", "solid", "thin"]>>;
    ...
    }>]>, "many">, ("copy" | "assistant" | "view" | "download-spec" | "chatgpt" | "claude" | "perplexity" | "grok" | "aistudio" | "devin" | "windsurf" | "mcp" | "add-mcp" | "cursor" | "vscode" | "devin-mcp" | {
        href: string | {
            base: string;
            query?: {
                value: string;
    ...
    })[], ("copy" | "assistant" | "view" | "download-spec" | "chatgpt" | "claude" | "perplexity" | "grok" | "aistudio" | "devin" | "windsurf" | "mcp" | "add-mcp" | "cursor" | "vscode" | "devin-mcp" | {
        href: string | {
            base: string;
            query?: {
                value: string;
    ...
    options: ("copy" | "assistant" | "view" | "download-spec" | "chatgpt" | "claude" | "perplexity" | "grok" | "aistudio" | "devin" | "windsurf" | "mcp" | "add-mcp" | "cursor" | "vscode" | "devin-mcp" | {
        href: string | {
            base: string;
            query?: {
                value: string;
