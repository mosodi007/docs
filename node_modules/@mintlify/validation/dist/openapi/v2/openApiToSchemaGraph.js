...
import { mapCallbackComponents } from './mapCallbackComponents.js';
...
export const openApiToSchemaGraph = ({ spec, filename, originalFileLocation, }) => {
    ...
    // document.components.callbacks -> Callback, Path, possibly Parameter, Operation, RequestBody, Response, SecurityRequirement, Server
    mapCallbackComponents({ spec, refUuidMap, uuidObjectHashMap, hashedNodeMap });
    // document.components.pathItems -> Path, possibly Parameter, Operation, RequestBody, Response, SecurityRequirement, Server, Callback
