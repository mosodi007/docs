...
export type GraphNode = SchemaOrRef | ResponseOrRef | HeaderOrRef | ParameterOrRef | Media | ExampleOrRef | RequestBodyOrRef | SecuritySchemeOrRef | CallbackOrRef | ServerObject | PathOrRef | Operation | SecurityRequirement | Document;
...
export type CallbackOrRefObject = CallbackObject | RefObject;
export type CallbackOrRef = (CallbackObject & {
    $ref?: never;
}) | (RefObject & {
    $ref: UUID;
});
